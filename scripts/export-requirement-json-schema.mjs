 ...
 * Prefer `shallgraph schema` when you have a project: it uses the same discovery as other commands
 ...
 * Requires `packages/core` to be built (`npm run build -w @shallgraph/core`).
 *
