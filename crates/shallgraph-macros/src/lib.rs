//! Attribute macros that tag Rust items as shallgraph source links.
//!
//! `#[shallgraph::implements("…")]` and `#[shallgraph::verifies("…")]` are available
//! when this crate is aliased as `shallgraph` (`extern crate shallgraph_macros as shallgraph`).
