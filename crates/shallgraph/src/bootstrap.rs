//! GRD-CLI-004: CLI bootstrap project – initialize a directory with shallgraph.yaml and requirements folder.

use shallgraph_core::{find_root_marker_path, ROOT_MARKER};
use std::fs;
...
pub struct BootstrapOptions {
    /// When true, overwrite existing shallgraph.yaml and do not fail if requirements dir exists.
    pub force: bool,
...
/// GRD-CLI-004: Bootstrap a directory with shallgraph.yaml and a requirements folder.
/// Optionally add .cursor rules. With force, overwrites shallgraph.yaml and skips creating requirements if it exists.
